package mx.preloaders
{
    ...
    public class DownloadProgressBar extends Sprite implements IPreloaderDisplay
    {
        ...
        {
            var _loc_2:* = param1.bytesLoaded;
            var _loc_3:* = param1.bytesTotal;
            var _loc_4:* = getTimer() - _startTime;
            if (_showingDisplay || showDisplayForDownloading(_loc_4, param1))
            {
                if (!_startedLoading)
                {
                    show();
        ...
        {
            var _loc_2:* = DisplayObject(LoaderInfo(param1.target).loader);
