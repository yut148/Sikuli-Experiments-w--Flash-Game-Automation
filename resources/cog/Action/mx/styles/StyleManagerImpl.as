...
{
    var _loc_2:* = IStyleModule(param1.module.factory.create());
    styleModules[param1.module.url].styleModule = _loc_2;
    if (update)
    {
        styleDeclarationsChanged();
    }// end if
...
function (param1:ModuleEvent) : void
{
    var _loc_3:StyleEvent;
    var _loc_2:* = resourceManager.getString("styles", "unableToLoad", [param1.errorText, url]);
    if (styleEventDispatcher.willTrigger(StyleEvent.ERROR))
    {
        _loc_3 = new StyleEvent(StyleEvent.ERROR, param1.bubbles, param1.cancelable);
