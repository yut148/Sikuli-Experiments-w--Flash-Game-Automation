package 
{
    ...
    private class StyleEventDispatcher extends EventDispatcher
    {
        ...
        {
            var _loc_2:* = new StyleEvent(StyleEvent.PROGRESS, param1.bubbles, param1.cancelable);
        ...
        {
            var _loc_2:* = new StyleEvent(StyleEvent.ERROR, param1.bubbles, param1.cancelable);
            _loc_2.bytesLoaded = param1.bytesLoaded;
            _loc_2.bytesTotal = param1.bytesTotal;
