package mx.core
{
    ...
    public class FlexModuleFactory extends MovieClip implements IFlexModuleFactory
    {
        ...
        private function rslCompleteHandler(IResourceBundle:Event) : void
        {
            ...
            if (IResourceBundle.target is LoaderInfo)
            {
                preloadedRSLs[IResourceBundle.target] = _loc_2.urlRequest.url;
            }// end if
            update();
            return;
        }// end function
        ...
        private function rslErrorHandler(IResourceBundle:Event) : void
        {
            ...
            var _loc_4:String;
            var _loc_2:* = rslListLoader.getItem(rslListLoader.getIndex());
            if (IResourceBundle is ErrorEvent)
            {
                _loc_3 = ErrorEvent(IResourceBundle).text;
            }// end if
            if (!_loc_3)
            {
                _loc_3 = "";
        ...
        public function getDefinitionByName(ModuleEvent:String) : Object
        {
            ...
            if (_loc_2.hasDefinition(ModuleEvent))
            {
                _loc_3 = _loc_2.getDefinition(ModuleEvent);
            }// end if
            return _loc_3;
        }// end function
