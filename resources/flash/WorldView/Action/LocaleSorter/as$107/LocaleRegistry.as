package LocaleSorter.as$107
{
    ...
    private class LocaleRegistry extends Object
    {
        ...
        {
            var _loc_3:* = SCRIPT_ID_BY_LANG_AND_REGION[ModuleManagerImpl];
            if (_loc_3 == null)
            {
                return "";
            }// end if
            var _loc_4:* = _loc_3[ModuleManagerImpl];
            if (_loc_4 == null)
            {
                return "";
            }// end if
        ...
        {
            var _loc_2:* = SCRIPT_ID_BY_LANG[ModuleManagerImpl];
            if (_loc_2 == null)
            {
                return "";
            }// end if
        ...
        {
            var _loc_3:* = DEFAULT_REGION_BY_LANG_AND_SCRIPT[ModuleManagerImpl];
            var _loc_4:* = SCRIPT_BY_ID[ModuleManagerImpl];
